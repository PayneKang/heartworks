...
namespace TankCity
{
    public class ExtendedSpriteBatch : SpriteBatch
    {
        ...
        {
            const short frameThickness = 40;
            this.Draw(this.WhiteTexture, new Rectangle(rectangle.Left, rectangle.Top, rectangle.Width, frameThickness), color);
            this.Draw(this.WhiteTexture, new Rectangle(rectangle.Left, rectangle.Bottom, rectangle.Width, frameThickness), color);
            this.Draw(this.WhiteTexture, new Rectangle(rectangle.Left, rectangle.Top, frameThickness, rectangle.Height), color);
            this.Draw(this.WhiteTexture, new Rectangle(rectangle.Right, rectangle.Top, frameThickness, rectangle.Height + frameThickness), color);
        }
